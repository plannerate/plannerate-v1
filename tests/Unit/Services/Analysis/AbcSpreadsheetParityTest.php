 ...
 *
 * A planilha é a ESPECIFICAÇÃO: é ela que define o que o negócio espera da curva ABC.
 * Os números abaixo são os dela, transcritos. Se este teste quebrar, o sistema deixou
 * de bater com o cliente — não relaxe a expectativa, investigue a regressão.
 *
 * A regra travada aqui (e que o sistema usava até 12/06/2026):
 ...
 *
 * O commit 01da121b (12/06/2026) trocou a regra para "acumulado ANTES do item" dentro
 * de um refactor de hierarquia de categorias. Isso promovia TODO item que cruza um
 * corte: o grupo REFINADO saía A,A,A,B — sem nenhum C, com o produto que fecha a curva
 * em 100% do acumulado classificado como B. E a tela exibia "acumulado 93,09%" ao lado
 * de "classe A", porque o serviço classificava por um número e mostrava outro.
 *
 * Validado ponta a ponta contra o banco real, na janela que a planilha usou:
 *   CRISTAL  (02/01..30/04)  A, A, C, C
 *   REFINADO (02/01..13/05)  A, A, B, C
 */
