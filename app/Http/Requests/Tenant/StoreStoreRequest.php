...
class StoreStoreRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'slug' => ['nullable', 'string', 'max:255', Rule::unique($storesTable, 'slug')->where('tenant_id', $tenantId)],
            'code' => ['nullable', 'string', 'max:255', Rule::unique($storesTable, 'code')->where('tenant_id', $tenantId)],
