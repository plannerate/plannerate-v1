...
class FallbackSalesFieldMap implements SalesFieldMap
{
    ...
    {
        return [
            'codigo_erp' => ['paths' => ['codigo_erp', 'produto'], 'transforms' => ['string', 'alnum']],
            'ean' => ['paths' => ['ean'], 'transforms' => ['ean']],
            'sale_date' => ['paths' => ['sale_date', 'data_venda', 'data'], 'transforms' => ['date']],
            'promotion' => ['paths' => ['promotion', 'promocao'], 'transforms' => ['string']],
