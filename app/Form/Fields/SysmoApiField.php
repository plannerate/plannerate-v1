...
class SysmoApiField extends SectionField
{
    public function __construct($name, $label = null)
    {
        parent::__construct($name, $label);
        $this->component('form-field-sysmo-api');
        ...
        $this->valueUsing(function ($data) {
            ...
            $integrationData['integration_type'] = 'sysmo';
            ...
            ->fields([
                ...
                \Callcocam\LaravelRaptor\Support\Form\Columns\Types\SectionField::make('authentication_body')
                    ...
                    ->nested()
                    ->fields([
                        \Callcocam\LaravelRaptor\Support\Form\Columns\Types\TextField::make('partner_key')
                            ->label('Chave Parceiro')
                            ->required()
                            ->default('Proplanner')
                            ->columnSpanThree(),
                        \Callcocam\LaravelRaptor\Support\Form\Columns\Types\TextField::make('pagina')
                            ...
                            ->default('1')
                            ->columnSpanThree(),
                        \Callcocam\LaravelRaptor\Support\Form\Columns\Types\TextField::make('tamanho_pagina')
                            ->label('Registros por Página')
                            ->required()
                            ->default('1000')
                            ->columnSpanThree(),
                        \Callcocam\LaravelRaptor\Support\Form\Columns\Types\TextField::make('tipo_consulta')
