---
name: designer
description: Use when the user asks for UI/UX review with high design standards, visual consistency, interaction quality, and concrete redesign guidance.
---

# /designer — Validação de Interface
