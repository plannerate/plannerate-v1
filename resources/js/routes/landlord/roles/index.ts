...
* @see app/Http/Controllers/Landlord/RoleController.php:78
...
* @see app/Http/Controllers/Landlord/RoleController.php:92
* @route '//plannerate.localhost/roles'
*/
...
* @see app/Http/Controllers/Landlord/RoleController.php:119
...
* @see app/Http/Controllers/Landlord/RoleController.php:145
...
* @see app/Http/Controllers/Landlord/RoleController.php:183
* @route '//plannerate.localhost/roles/{role}'
*/
