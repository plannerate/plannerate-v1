...
/**
* @see \Callcocam\WhatsAppCloud\Http\Controllers\SandboxController::faults
...
*/
export const faults = (options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: faults.url(options),
    method: 'post',
})
...
* @route '/whatsapp/cloud/sandbox/faults'
*/
faults.url = (options?: RouteQueryOptions) => {
    return faults.definition.url + queryParams(options)
}
...
* @route '/whatsapp/cloud/sandbox/faults'
*/
faults.post = (options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: faults.url(options),
    method: 'post',
})
...
* @route '/whatsapp/cloud/sandbox/faults'
*/
const faultsForm = (options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
    action: faults.url(options),
    method: 'post',
})
...
* @route '/whatsapp/cloud/sandbox/faults'
*/
faultsForm.post = (options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
    action: faults.url(options),
    method: 'post',
})

faults.form = faultsForm
...
const sandbox = {
    ...
    tap: Object.assign(tap, tap),
    sendTemplate: Object.assign(sendTemplate, sendTemplate),
    sendText: Object.assign(sendText, sendText),
    status: Object.assign(status, status),
    faults: Object.assign(faults, faults),
    closeWindow: Object.assign(closeWindow, closeWindow),
