...
const pageMeta = useCrudPageMeta({
    headTitle: isEdit.value
        ? t('app.tenant.clusters.actions.edit')
                ...
                >
                    ...
                    <div class="grid grid-cols-1 gap-4 md:grid-cols-12">
                        ...
                        <FormTextField
                            ...
                            :label="
                                t('app.tenant.clusters.fields.specification_1')
                            "
                            :default-value="
                                props.cluster?.specification_1 ?? ''
                            "
                        ...
                        <FormTextField
                            ...
                            :label="
                                t('app.tenant.clusters.fields.specification_2')
                            "
                            :default-value="
                                props.cluster?.specification_2 ?? ''
                            "
                        ...
                        <FormTextField
                            ...
                            :label="
                                t('app.tenant.clusters.fields.specification_3')
                            "
                            :default-value="
                                props.cluster?.specification_3 ?? ''
                            "
