...
<template>
    ...
    <div class="px-6 py-6">
        <ListPage :title="pageMeta.title" :description="pageMeta.description" :meta="props.categories"
            label="categoria" :action="categoriesIndexPath" :clear-href="categoriesIndexPath"
