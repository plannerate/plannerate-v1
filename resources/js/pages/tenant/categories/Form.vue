...
const pageMeta = useCrudPageMeta({
    headTitle: isEdit.value
        ? t('app.tenant.categories.actions.edit')
...
const statusOptions = computed(() => [
    ...
    {
        value: 'published',
        label: t('app.tenant.categories.status_options.published'),
    },
    {
        value: 'importer',
        label: t('app.tenant.categories.status_options.importer'),
    },
]);
</script>
                ...
                >
                    ...
                    <div class="grid gap-4 md:grid-cols-3">
                        ...
                        <FormTextField
                            ...
                            :label="
                                t(
                                    'app.tenant.categories.fields.hierarchy_position',
                                )
                            "
                            :default-value="
                                String(props.category?.hierarchy_position ?? '')
                            "
                    ...
                    <div class="grid gap-4 md:grid-cols-3">
                        <FormTextField
                            ...
                            name="level_name"
                            :label="
                                t('app.tenant.categories.fields.level_name')
                            "
                    ...
                    <input
                        ...
                        name="hierarchy_path[]"
                        :value="
                            (props.category?.hierarchy_path ?? []).join(' > ')
                        "
                    />
