...
const pageMeta = useCrudPageMeta({
    headTitle: isEdit.value
        ? t('app.tenant.ean_references.actions.edit')
            ...
            >
                ...
                >
                    ...
                    <div class="grid gap-2">
                        <Label for="ean">{{
                            t('app.tenant.ean_references.fields.ean')
                        }}</Label>
                        <Input
                            id="ean"
                            name="ean"
                            :default-value="props.ean_reference?.ean ?? ''"
                            required
                        />
                    ...
                    <div class="grid gap-2">
                        <Label for="reference_description">{{
                            t(
                                'app.tenant.ean_references.fields.reference_description',
                            )
                        }}</Label>
                        <textarea
                            ...
                            :value="
                                props.ean_reference?.reference_description ?? ''
                            "
                        ></textarea>
                    ...
                    <div class="grid gap-4 md:grid-cols-2">
                        <div class="grid gap-2">
                            <Label for="brand">{{
                                t('app.tenant.ean_references.fields.brand')
                            }}</Label>
                            <Input
                                id="brand"
                                name="brand"
                                :default-value="
                                    props.ean_reference?.brand ?? ''
                                "
                            />
                        ...
                        <div class="grid gap-2">
                            <Label for="subbrand">{{
                                t('app.tenant.ean_references.fields.subbrand')
                            }}</Label>
                            <Input
                                id="subbrand"
                                name="subbrand"
                                :default-value="
                                    props.ean_reference?.subbrand ?? ''
                                "
                            />
                        ...
                        <div class="grid gap-2">
                            <Label for="packaging_type">{{
                                t(
                                    'app.tenant.ean_references.fields.packaging_type',
                                )
                            }}</Label>
                            <Input
                                id="packaging_type"
                                name="packaging_type"
                                :default-value="
                                    props.ean_reference?.packaging_type ?? ''
                                "
                            />
                        ...
                        <div class="grid gap-2">
                            <Label for="packaging_size">{{
                                t(
                                    'app.tenant.ean_references.fields.packaging_size',
                                )
                            }}</Label>
                            <Input
                                id="packaging_size"
                                name="packaging_size"
                                :default-value="
                                    props.ean_reference?.packaging_size ?? ''
                                "
                            />
                        ...
                        <div class="grid gap-2">
                            <Label for="measurement_unit">{{
                                t(
                                    'app.tenant.ean_references.fields.measurement_unit',
                                )
                            }}</Label>
                            <Input
                                id="measurement_unit"
                                ...
                                :default-value="
                                    props.ean_reference?.measurement_unit ?? ''
                                "
                            />
                    ...
                    <div class="mt-2 border-t border-border pt-4">
                        ...
                        <div class="grid gap-4 md:grid-cols-2">
                            ...
                            <FormStatusToggleField
                                ...
                                label="Status da dimensao"
                                :default-value="
                                    props.ean_reference?.dimension_status ??
                                    'published'
                                "
