    ...
    >
        ...
        >
            ...
            >
                ...
                >
                    <h1 class="mb-1 font-medium">{{ t('app.welcome_page.get_started') }}</h1>
                    <p class="mb-2 text-[#706f6c] dark:text-[#A1A09A]">
                        {{ t('app.welcome_page.description') }}
                    </p>
                    <ul class="mb-4 flex flex-col lg:mb-6">
                        ...
                        >
                            ...
                            <span>
                                {{ t('app.welcome_page.watch_tutorials') }}
                                <a
