...
<template>
    ...
    <div class="relative my-6">
        ...
        <div class="relative flex justify-center text-[10px]">
            <span class="bg-background px-3 font-semibold uppercase tracking-widest text-muted-foreground">
                ou continue com
            </span>
        </div>
    </div>
    ...
    <div class="flex flex-col gap-2.5">
        <button
            type="button"
            disabled
            class="flex w-full items-center justify-center gap-3 rounded-lg border border-border bg-background px-4 py-2.5 text-sm font-medium text-foreground/50 transition cursor-not-allowed"
            title="Em breve"
        >
            <!-- Google G -->
