        ...
        <div class="space-y-6 p-4"> 
            ...
            >
                <div class="mt-0.5 shrink-0">
                    ...
                    />
                    <AlertCircle v-else class="size-6 text-destructive" />
                </div>
                <div class="flex-1 space-y-1">
                    <p class="font-semibold text-foreground">
                        <span v-if="tenant.status === 'provisioning'">{{
                            t('app.landlord.tenants.setup.provisioning_message')
                        }}</span>
                        <span v-else-if="tenant.status === 'active'">{{
                            t('app.landlord.tenants.setup.active_message')
                        }}</span>
                        <span v-else>{{
                            t('app.landlord.tenants.setup.error_message')
                        }}</span>
                    </p>
                    <p
                ...
                <div v-if="tenant.status !== 'provisioning'" class="shrink-0">
                    ...
                    >
                        ...
                        >
                            {{
                                t(
                                    'app.landlord.tenants.setup.manage_users_button',
                                )
                            }}
                        </Link>
                    </Button>
                    ...
                    >
                        ...
                        {{
                            tenant.provisioning_error
                                ...
                                : t(
                                      'app.landlord.tenants.setup.provision_button',
                                  )
                        }}
                    </Button>
                </div>
            ...
            <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 xl:grid-cols-4">
                ...
                >
                    ...
                    <div class="min-w-0">
                        ...
                        <p
                            class="mt-1 truncate font-semibold text-foreground capitalize"
                        >
                            {{ tenant.status }}
                        </p>
                    </div>
                ...
                >
                    ...
                    <div class="min-w-0">
                        ...
                        <p
                            class="mt-1 truncate font-mono text-sm font-semibold text-foreground"
                        >
                            {{ tenant.database }}
                        </p>
                    </div>
            ...
            <div class="rounded-xl border border-border bg-card p-6">
                <h3
                    class="mb-4 text-sm font-semibold tracking-widest text-muted-foreground uppercase"
                >
                ...
                <ol class="space-y-3">
                    ...
                    >
                        ...
                        >
                            ...
                            />
                            <Clock
                                v-else-if="tenant.status === 'provisioning'"
