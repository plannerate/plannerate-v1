...
const pageMeta = useCrudPageMeta({
    ...
    title: isEdit.value ? t('app.landlord.ean_references.actions.edit') : t('app.landlord.ean_references.actions.new'),
    description: t('app.landlord.ean_references.description'),
    breadcrumbs: [
        {
        ...
        {
            title: t('app.landlord.ean_references.navigation'),
            ...
            >
                ...
                >
                    ...
                    <div class="grid gap-2">
                        <Label for="ean">{{ t('app.landlord.ean_references.fields.ean') }}</Label>
                        <Input id="ean" name="ean" :default-value="props.ean_reference?.ean ?? ''" required />
                        <InputError :message="errors.ean" />
                    </div>

                    <div class="grid gap-2">
                        <Label for="reference_description">{{ t('app.landlord.ean_references.fields.reference_description') }}</Label>
                        <textarea
