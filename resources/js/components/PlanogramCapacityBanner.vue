<template>
  <div v-if="report && report.mix_excede_gondola" class="rounded-lg border border-amber-200 bg-amber-50 p-4">
  ...
  <div v-if="report && report.rejeitados_altura > 0" class="rounded-lg border border-blue-200 bg-blue-50 p-4">
    <div class="flex items-start gap-3">
