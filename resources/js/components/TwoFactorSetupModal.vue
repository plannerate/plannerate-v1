...
const modalConfig = computed<{
    ...
    if (props.twoFactorEnabled) {
        return {
            ...
            description:
                'A autenticação de dois fatores está agora habilitada. Escaneie o código QR ou digite a chave de configuração no seu aplicativo autenticador.',
            buttonText: 'Fechar',
        };
    }
    ...
    return {
        ...
        description:
            'Para finalizar a habilitação da autenticação de dois fatores, escaneie o código QR ou digite a chave de configuração no seu aplicativo autenticador',
        buttonText: 'Continuar',
    };
});
