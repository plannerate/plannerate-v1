...
/**
* @see \App\Http\Controllers\Landlord\WorkflowTemplateController::seedDefaultTemplates
...
*/
export const seedDefaultTemplates = (args: { tenant: string | { id: string } } | [tenant: string | { id: string } ] | string | { id: string }, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: seedDefaultTemplates.url(args, options),
    method: 'post',
})

seedDefaultTemplates.definition = {
    methods: ["post"],
...
* @route '//plannerate.localhost/tenants/{tenant}/kanban/templates/seed-defaults'
*/
seedDefaultTemplates.url = (args: { tenant: string | { id: string } } | [tenant: string | { id: string } ] | string | { id: string }, options?: RouteQueryOptions) => {
    if (typeof args === 'string' || typeof args === 'number') {
        args = { tenant: args }
    }
    ...
    return seedDefaultTemplates.definition.url
            .replace('{tenant}', parsedArgs.tenant.toString())
            .replace(/\/+$/, '') + queryParams(options)
}
...
* @route '//plannerate.localhost/tenants/{tenant}/kanban/templates/seed-defaults'
*/
seedDefaultTemplates.post = (args: { tenant: string | { id: string } } | [tenant: string | { id: string } ] | string | { id: string }, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: seedDefaultTemplates.url(args, options),
    method: 'post',
})
...
* @route '//plannerate.localhost/tenants/{tenant}/kanban/templates/seed-defaults'
*/
const seedDefaultTemplatesForm = (args: { tenant: string | { id: string } } | [tenant: string | { id: string } ] | string | { id: string }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
    action: seedDefaultTemplates.url(args, options),
    method: 'post',
})
...
* @route '//plannerate.localhost/tenants/{tenant}/kanban/templates/seed-defaults'
*/
seedDefaultTemplatesForm.post = (args: { tenant: string | { id: string } } | [tenant: string | { id: string } ] | string | { id: string }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
    action: seedDefaultTemplates.url(args, options),
    method: 'post',
})

seedDefaultTemplates.form = seedDefaultTemplatesForm
...
const WorkflowTemplateController = { index, create, store, seedDefaultTemplates, edit, update, syncUsers, destroy }
