...
/**
* @see \App\Http\Controllers\Tenant\ProductDimensionController::syncPageFromReference
* @see app/Http/Controllers/Tenant/ProductDimensionController.php:116
* @route '/dimensions/sync-from-reference-page'
*/
export const syncPageFromReference = (options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: syncPageFromReference.url(options),
    method: 'post',
})

syncPageFromReference.definition = {
    methods: ["post"],
...
* @route '/dimensions/sync-from-reference-page'
*/
syncPageFromReference.url = (options?: RouteQueryOptions) => {
    return syncPageFromReference.definition.url + queryParams(options)
}
...
* @route '/dimensions/sync-from-reference-page'
*/
syncPageFromReference.post = (options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: syncPageFromReference.url(options),
    method: 'post',
})
...
* @route '/dimensions/sync-from-reference-page'
*/
const syncPageFromReferenceForm = (options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
    action: syncPageFromReference.url(options),
    method: 'post',
})
...
* @route '/dimensions/sync-from-reference-page'
*/
syncPageFromReferenceForm.post = (options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
    action: syncPageFromReference.url(options),
    method: 'post',
})

syncPageFromReference.form = syncPageFromReferenceForm
...
const ProductDimensionController = { index, syncPageFromReference, syncFromReference, update }
