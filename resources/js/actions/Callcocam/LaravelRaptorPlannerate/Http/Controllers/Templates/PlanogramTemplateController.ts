...
const PlanogramTemplateController = { index, options, importPage, importMethod, exportAll, create, store, show, edit, update, destroy, exportMethod, promote, import: importMethod, export: exportMethod }

export default PlanogramTemplateController