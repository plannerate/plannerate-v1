    ...
    'landlord' => [
        ...
        'integration_apis' => [
            ...
            'placeholders' => [
                ...
                'api_field' => 'produto',
                'calculated_field' => 'total_profit_margin',
            ],
            'empty_states' => [
                'paths' => 'Nenhuma configuração de requisição criada.',
                'field_map' => 'Nenhum campo mapeado.',
                'calculations' => 'Nenhum cálculo configurado.',
                'operands' => 'Adicione campos no field map para selecionar operandos.',
            ],
            'operations' => [
                'sum' => 'Somar',
                'subtract' => 'Subtrair',
