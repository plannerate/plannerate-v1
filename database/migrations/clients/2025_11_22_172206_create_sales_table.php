...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('sales', function (Blueprint $table) {
            $table->char('id', 26)->primary()->comment("Identificador único da venda");
            $table->char('tenant_id', 26)->nullable()->comment("Identificador do tenant (multi-tenant)");
            $table->char('client_id', 26)->nullable()->comment("Identificador do cliente");
            $table->char('store_id', 26)->nullable()->comment("Identificador da loja");
            $table->char('product_id', 26)->nullable()->comment("Identificador do produto");
            ...
            $table->unique(['tenant_id', 'client_id', 'store_id', 'codigo_erp', 'sale_date', 'promotion'], 'sales_unique_constraint');
            $table->index(['product_id', 'margem_contribuicao'], 'sales_product_margem_idx');
        }); 
    }
