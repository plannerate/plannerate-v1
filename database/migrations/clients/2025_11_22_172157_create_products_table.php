...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('products', function (Blueprint $table) {
            ...
            $table->char('image_id', 26)->nullable();
            $table->char('category_id', 26)->nullable();
            $table->char('client_id', 26)->nullable()->comment("Identificador do cliente (de product_additional_data)");
            $table->char('store_id', 26)->nullable()->comment("Identificador da loja (de product_additional_data)");
