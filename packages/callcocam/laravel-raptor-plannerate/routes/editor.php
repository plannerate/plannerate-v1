...
Route::prefix('api')->name('api.')->group(function () {
    ...
    Route::get('editor/sections/{section}', [\Callcocam\LaravelRaptorPlannerate\Http\Controllers\Editor\SectionController::class, 'show'])
        ->name('editor.sections.show');
    Route::post('editor/gondolas/{gondola}/sections', [\Callcocam\LaravelRaptorPlannerate\Http\Controllers\Editor\SectionController::class, 'store'])
        ->name('editor.sections.store');
    Route::put('editor/sections/{id}', [\Callcocam\LaravelRaptorPlannerate\Http\Controllers\Editor\SectionController::class, 'update'])
        ->name('editor.sections.update');
    Route::delete('editor/sections/{section}', [\Callcocam\LaravelRaptorPlannerate\Http\Controllers\Editor\SectionController::class, 'destroy'])
        ->name('editor.sections.destroy');
    Route::post('editor/sections/{section}/transfer', [\Callcocam\LaravelRaptorPlannerate\Http\Controllers\Editor\SectionController::class, 'transfer'])
        ->name('editor.sections.transfer');

    // Editor API Routes - Planograms & Gondolas
    Route::get('editor/planograms', [\Callcocam\LaravelRaptorPlannerate\Http\Controllers\Editor\PlanogramApiController::class, 'index'])
        ->name('editor.planograms.index');
    Route::get('editor/planograms/{planogram}/gondolas', [\Callcocam\LaravelRaptorPlannerate\Http\Controllers\Editor\PlanogramApiController::class, 'gondolas'])
        ->name('editor.planograms.gondolas');

    // Editor API Routes - Shelves
    Route::post('editor/sections/{section}/shelves', [\Callcocam\LaravelRaptorPlannerate\Http\Controllers\Editor\ShelfController::class, 'store'])
        ->name('editor.shelves.store');
    Route::put('editor/shelves/{id}', [\Callcocam\LaravelRaptorPlannerate\Http\Controllers\Editor\ShelfController::class, 'update'])
        ->name('editor.shelves.update');
    Route::delete('editor/shelves/{shelf}', [\Callcocam\LaravelRaptorPlannerate\Http\Controllers\Editor\ShelfController::class, 'destroy'])
        ->name('editor.shelves.destroy');

    // Editor API Routes - Segments
    Route::put('editor/segments/{id}', [\Callcocam\LaravelRaptorPlannerate\Http\Controllers\Editor\SegmentController::class, 'update'])
        ->name('editor.segments.update');

    // Editor API Routes - Layers
    Route::put('editor/layers/{id}', [\Callcocam\LaravelRaptorPlannerate\Http\Controllers\Editor\LayerController::class, 'update'])
        ->name('editor.layers.update');
    Route::delete('editor/layers/{layer}', [\Callcocam\LaravelRaptorPlannerate\Http\Controllers\Editor\LayerController::class, 'destroy'])
        ->name('editor.layers.destroy');

    // Gondola Save Changes (Delta/Diff)
    Route::post('editor/gondolas/{gondola}/save-changes', \Callcocam\LaravelRaptorPlannerate\Http\Controllers\Editor\SaveChangesController::class)
        ->name('editor.gondolas.save-changes');

    // Product Dimensions API
    Route::post('plannograma/{planogram}/products/{product}/dimensions', [\Callcocam\LaravelRaptorPlannerate\Http\Controllers\Editor\ProductDimensionController::class, 'update'])
        ->name('editor.products.dimensions.update');

    // Product Sales Summary API
    Route::get('plannerate/products/{product}/sales/summary', [\Callcocam\LaravelRaptorPlannerate\Http\Controllers\Editor\ProductSalesController::class, 'summary'])
        ->name('plannerate.products.sales.summary');

    // Performance Analysis API - ABC e Estoque Alvo
    Route::post('editor/gondolas/{gondola}/analysis/abc', [\Callcocam\LaravelRaptorPlannerate\Http\Controllers\GondolaAnalysisController::class, 'calculateAbcApi'])
        ->name('editor.gondolas.analysis.abc');
    Route::post('editor/gondolas/{gondola}/analysis/target-stock', [\Callcocam\LaravelRaptorPlannerate\Http\Controllers\GondolaAnalysisController::class, 'calculateTargetStockApi'])
        ->name('editor.gondolas.analysis.target-stock');
    Route::delete('editor/gondolas/{gondola}/analysis', [\Callcocam\LaravelRaptorPlannerate\Http\Controllers\GondolaAnalysisController::class, 'clearAnalysisApi'])
