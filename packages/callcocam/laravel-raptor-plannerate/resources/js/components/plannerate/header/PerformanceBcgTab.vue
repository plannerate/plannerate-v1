        ...
        <BcgResultsList v-else-if="results.length > 0" :results="results" :loading="loading">
            <template #top>
                <div class="flex flex-wrap items-center gap-2">
                    ...
                    <div v-if="form.table_type === 'sales' && form.date_from"
                    ...
                    <div v-if="form.table_type === 'sales' && form.date_to"
                        class="inline-flex min-w-40 items-center justify-between rounded-md bg-accent/40 px-2 py-1 text-[11px]">
                        <span class="inline-flex items-center gap-1 text-muted-foreground">
                            <Calendar class="size-3.5" />
                    ...
                    <div v-if="form.table_type === 'monthly_summaries' && form.start_month"
                        class="inline-flex min-w-40 items-center justify-between rounded-md bg-accent/40 px-2 py-1 text-[11px]">
                        <span class="inline-flex items-center gap-1 text-muted-foreground">
                            <Calendar class="size-3.5" />
                    ...
                    <div v-if="form.table_type === 'monthly_summaries' && form.end_month"
                        class="inline-flex min-w-40 items-center justify-between rounded-md bg-accent/40 px-2 py-1 text-[11px]">
                        <span class="inline-flex items-center gap-1 text-muted-foreground">
                            <Calendar class="size-3.5" />
...
const getStorageKey = (gondolaId: string): string => `plannerate:performance:bcg:params:${gondolaId}`;
