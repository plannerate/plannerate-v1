...
/**
 * Constrói o estado inicial do formulário a partir dos dados recebidos via prop
 */
...
<template>
    <Dialog :open="open" @update:open="handleOpenChange">
        <DialogContent class="z-[600] max-h-[90vh] max-w-2xl overflow-y-auto">
