    ...
    <Card class="h-fit">
        ...
        <CardContent class="max-h-[55vh] overflow-y-auto pt-0">
            <div v-if="selected" class="space-y-2">
                ...
                <!-- Histórico de vendas do produto: só no modo produto, não em grupos agregados -->
                <ProductSalesSummary v-if="!selected.display_by || selected.display_by === 'produto'" :product-id="selected.product_id" />
            </div>
