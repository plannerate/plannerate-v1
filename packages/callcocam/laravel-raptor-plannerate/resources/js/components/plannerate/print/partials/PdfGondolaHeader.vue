        ...
        <div class="flex items-center justify-between gap-6">
            ...
            <div class="flex shrink-0 items-center gap-3">
                ...
                <div class="border-l border-slate-200 pl-3">
                    ...
                    <h1
                        class="text-2xl leading-none font-black tracking-wide text-slate-900 uppercase"
                    >
                        {{ title }}
                    </h1>
                </div>
            ...
            <!-- Metadados em linha -->
            <div
                class="flex flex-wrap items-start justify-end gap-x-5 gap-y-2"
            >
                <div
                ...
                >
                    <div class="flex items-center gap-1">
                        ...
                        />
                        <span
                            class="text-[11px] tracking-wider text-slate-400 uppercase"
                            >{{ item.label }}</span
                        >
                    </div>
                    <span
