...
<template>
    <div class="px-6 py-4 border-b-2 border-primary flex items-center justify-between gap-4 w-full">
        <!-- Logo -->
        <div class="shrink-0">
            <img src="/img/marca-claro.png" alt="Logo" class="h-10 w-auto block dark:hidden" />
            <img src="/img/marcadark.png" alt="Logo" class="h-10 w-auto hidden dark:block" />
        </div>
