    ...
    >
        ...
        >
            <Segment
                ...
                :isFirstInShelf="index === 0"
                :isLastInShelf="index === segments.length - 1"
                :fill-section-width="isSingleSegmentJustify"
                :internal-alignment="
                    isSingleSegmentJustify ? 'justify' : undefined
                "
        ...
        >
            <div
                v-if="isDropTarget"
                class="pointer-events-none absolute inset-0 z-[140] flex flex-col items-center justify-center gap-2 rounded-sm border-2 border-dashed border-primary bg-primary/10 backdrop-blur-sm"
            >
                <svg
                    class="size-8 text-primary drop-shadow-lg"
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                >
        ...
        <div
            ...
            class="absolute right-0 left-0 z-[120] cursor-grab border-t-2 border-slate-700 bg-slate-800/95 hover:z-[130] active:cursor-grabbing dark:border-slate-600 dark:bg-slate-700/95"
            :class="{
            ...
            @dragstart.stop="handleShelfDragStart"
            @dragend.stop="handleShelfDragEnd"
