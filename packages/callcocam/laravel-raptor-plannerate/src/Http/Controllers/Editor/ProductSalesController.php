    ...
    public function summary(Request $request, string $productId): JsonResponse
    {
        ...
        $salesSummary = $baseQuery()
            ->selectRaw('
                ...
                SUM(margem_contribuicao) as total_margin,
                ...
                (SUM(margem_contribuicao) / NULLIF(SUM(total_sale_value), 0)) * 100 as margin_percentage,
